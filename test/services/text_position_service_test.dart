...
import 'package:wisemuse/services/text_position_service.dart';
...
void main() {
  group('buildSentences', () {
    ...
    test('句子跨行合并: 自动折行的两行合成一句, rects 每行一个', () {
